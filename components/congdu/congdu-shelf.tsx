...
import { loadBooks, addBook, deleteBook, saveChapters, loadProgress, saveRawFile } from "@/lib/congdu-storage";
import { decodeTxtArrayBuffer, parseTxtContent, parseEpubFile, PDF_PAGES_PER_CHAPTER } from "@/lib/congdu-parser";
import type { Book, BookChapter } from "@/lib/congdu-types";
import type { ReadingAppearance } from "@/lib/congdu-appearance";
import { CongduAppearanceDialog } from "./congdu-appearance-dialog";
...
const IMPORT_DIAG_KEY = "congdu-import-diagnostic-v1";
...
export function CongduShelf({ onOpenBook, onClose, appearance, backgroundUrl, onSaveAppearance }: Props) {
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            console.error("[Congdu] Import failed:", err);
        ...
        <div className="reading-app-surface absolute inset-0 z-[100] flex flex-col">
            <header className="reading-shelf-header">
                ...
                <div className="reading-shelf-title-stack">
                    <h1 className="reading-shelf-title">共读</h1>
